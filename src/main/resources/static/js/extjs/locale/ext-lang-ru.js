...
Ext.define("Ext.locale.ru.form.field.Date", {
    ...
    format: "d.m.Y",
    altFormats: "d.m.Y|d,m,Y|d,m,y|d.m.y|d/m/Y|d-m-y|d-m-Y|d/m|d-m|dm|dmy|dmY|d|Y-m-d"
});
Ext.define("Ext.locale.ru.form.field.Time", {
    ...
    invalidText: "{0} недопустимый формат времени ",
    format: "H:i",
    altFormats: "Hi|g:ia|g:iA|g:i a|g:i A|h:i|g:i|H:i|ga|ha|gA|h a|g a|g A|gi|hi|gia|hia|g|H"
});
...
if(Ext.ux.form.ItemSelector){
    Ext.apply(Ext.ux.form.ItemSelector.prototype,{
        buttonsText:{
            top: "Вниз"
            ,up: "Выше"
            ,add: "Добавить"
        ...
        ,minSelectionsText:'Минимальное разрешеное количество: {0}'
        ,maxSelectionsText:'Максимальное разрешеное количество {0}'
        ,dragText:'{0} штук'
        ,fromListTitle:'Доступно'
        ,toListTitle:'Выбрано'
    });
}
if(Ext.ux.form.MultiSelect){
